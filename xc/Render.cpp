...
{ 
	//font.Default = 0x78d; // MainMenu Font from vgui_spew_fonts 
    font.ESP = g_Surface->FontCreate();
    font.Guns = g_Surface->FontCreate();
	font.Test = g_Surface->FontCreate();
    font.Defuse = g_Surface->FontCreate();
    font.Time = g_Surface->FontCreate();
    font.DroppedGuns = g_Surface->FontCreate();
	font.Logo = g_Surface->FontCreate();
	font.LBY = g_Surface->FontCreate();
	font.C4Timer = g_Surface->FontCreate();



	//g_Surface->SetFontGlyphSet(font.ESP, "Tahoma", 11, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.ESP, "Tahoma", 11, 700, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 15, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Guns, "Tahoma", 12, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Test, "tahomabd", 15, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Time, "Verdana", 13, 550, 0, 0, FONTFLAG_NONE);
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Tahoma", 8, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Logo, "Tahoma", 13, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.LBY, "Tahoma", 40, 900, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.C4Timer, "Tahoma", 20, 900, 0, 0, FONTFLAG_DROPSHADOW);
