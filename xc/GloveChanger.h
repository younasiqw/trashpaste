...
void GloveChanger()
{
    ...
    *reinterpret_cast<int*>(uintptr_t(glove) + 0x64) = -1;
	...
	//  GONNA BE STARTING HERE I GUESS
    ...
    if (glove) 
    {
		...
		switch (g_Options.Skinchanger.glovesskin) //Blood 4 //Handwrap 4 //Driver 4 //Sport 4 //Motorcycle 4 //Specialist 4
		{
		case 0:
			break;
		case 1:
			*glove->FallbackPaintKit() = 10007;//Blood
			break;
		case 2:
			*glove->FallbackPaintKit() = 10006;//Blood 
			break;
		case 3:
			*glove->FallbackPaintKit() = 10039;//Blood
			break;
		case 4:
			*glove->FallbackPaintKit() = 10008;//Blood
			break;
		case 5:
			*glove->FallbackPaintKit() = 10021;//Handwrap
			break;
		case 6:
			*glove->FallbackPaintKit() = 10036;//Handwrap
			break;
		case 7:
			*glove->FallbackPaintKit() = 10009;//Handwrap
			break;
		case 8:
			*glove->FallbackPaintKit() = 10010;//Handwrap
			break;
		case 9:
			*glove->FallbackPaintKit() = 10016;//Driver
			break;
		case 10:
			*glove->FallbackPaintKit() = 10013;//Driver
			break;
		case 11:
			*glove->FallbackPaintKit() = 10040;//Driver
			break;
		case 12:
			*glove->FallbackPaintKit() = 10015;//Driver
			break;
		case 13:
			*glove->FallbackPaintKit() = 10037;//Sport
			break;
		case 14:
			*glove->FallbackPaintKit() = 10038;//Sport
			break;
		case 15:
			*glove->FallbackPaintKit() = 10018;//Sport
			break;
		case 16:
			*glove->FallbackPaintKit() = 10019;//Sport
			break;
		case 17:
			*glove->FallbackPaintKit() = 10026;//Motorcycle
			break;
		case 18:
			*glove->FallbackPaintKit() = 10028;//Motorcycle
			break;
		case 19:
			*glove->FallbackPaintKit() = 10027;//Motorcycle
			break;
		case 20:
			*glove->FallbackPaintKit() = 10024;//Motorcycle
			break;
		case 21:
			*glove->FallbackPaintKit() = 10033;//Specialist
			break;
		case 22:
			*glove->FallbackPaintKit() = 10034;//Specialist
			break;
		case 23:
			*glove->FallbackPaintKit() = 10035;//Specialist
			break;
		case 24:
			*glove->FallbackPaintKit() = 10030;//Specialist
			break;
		}
		...
		*glove->AccountID() = localPlayerInfo.xuid;
		//*glove->m_AttributeManager()->m_Item()->AccountID() = LocalPlayerInfo.xuidlow;
