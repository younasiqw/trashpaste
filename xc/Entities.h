...
public:
	...
	bool m_bSpotted()
	{
		static int meme = NetVarManager->GetOffset("DT_BaseEntity", "m_bSpotted");
		return *(bool*)((uintptr_t)this + meme);
	}
	float GetNextAttack()
	{
	...
	bool IsAlive()
	{
		...
		CUtlVector<AnimationLayer> GetAnimationOverlay() {
			return (CUtlVector<AnimationLayer>)((DWORD)this + 0x3884);//0x2970);
	}
