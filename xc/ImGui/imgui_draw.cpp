...
ImFont* ImFontAtlas::AddFontDefault(const ImFontConfig* font_cfg_template)
{
	...
	if (font_cfg.Name[0] == '\0') fopen("c:/windows/fonts/verdana.ttf", "rb");
	if (font_cfg.SizePixels <= 0.0f) font_cfg.SizePixels = 7.0f;

	const char* ttf_compressed_base85 = GetDefaultCompressedFontDataTTFBase85();
	ImFont* font = AddFontFromFileTTF("C:\\Windows\\Fonts\\verdana.ttf", font_cfg.SizePixels);
